...
- [D07 资源预算与共享组件设计方案 v1](docs/ui/D07_资源预算与共享组件设计方案_v1.html)
...
当前 main 已占 6 MiB 槽约 91%。D07 已进入方案审批，建议将内置字体限制为 128 KiB、内置图片限制为 1 MiB，并把 D07 main 控制在 4 MiB 内；审批前不实施字体或组件代码。`flash1` 的 FAL 持久化、低功耗和长期测试尚未关闭。仓库目前没有可直接投产的佩戴版 PCB 或完整 watchOS 界面。
