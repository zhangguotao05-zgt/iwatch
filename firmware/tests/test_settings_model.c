...
int main(void)
{
    ...
    assert(iw_brightness_detail_level(INT32_MIN) == 5 && iw_brightness_detail_level(INT32_MAX) == 100);
    assert(iw_brightness_detail_level(114) == 5 && iw_brightness_detail_level(276) == 100);
